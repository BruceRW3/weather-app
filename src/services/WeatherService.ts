...
const key: string = 'da191dd03ab32613ff0cf3bca2230735';
if (key === undefined) {
    throw new Error('No Open Weather API key defined - ensure you set a variable calle REACT_APP_OPEN_WEATHER_API_KEY')
};
